...
Source0  : https://files.pythonhosted.org/packages/a0/07/d8af4634358e0fdd3968bb021c20fdfbe9c062e92765971f93eddeb7f828/pytest-xdist-2.4.0.tar.gz
...
%prep
%setup -q -n pytest-xdist-2.4.0
cd %{_builddir}/pytest-xdist-2.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632234108
...
cp %{_builddir}/pytest-xdist-2.4.0/LICENSE %{buildroot}/usr/share/package-licenses/pytest-xdist/82dbfd684f7c04da81d4faa852c6317142daa3e7
