...
Version  : 2.3.0
Release  : 87
URL      : https://files.pythonhosted.org/packages/d8/2a/d6333010844cd3931a57d17ae1203d2404fee689704c3f9a665c31d7faae/pytest-xdist-2.3.0.tar.gz
...
%prep
%setup -q -n pytest-xdist-2.3.0
cd %{_builddir}/pytest-xdist-2.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1623940967
...
cp %{_builddir}/pytest-xdist-2.3.0/LICENSE %{buildroot}/usr/share/package-licenses/pytest-xdist/82dbfd684f7c04da81d4faa852c6317142daa3e7
