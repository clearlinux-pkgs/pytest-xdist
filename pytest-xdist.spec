...
Version  : 1.34.0
Release  : 74
URL      : https://files.pythonhosted.org/packages/e4/d1/e1786c190f4010b04e7cbfbd927e0d78d9e32af9ba2cae49640fa31057cf/pytest-xdist-1.34.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/e4/d1/e1786c190f4010b04e7cbfbd927e0d78d9e32af9ba2cae49640fa31057cf/pytest-xdist-1.34.0.tar.gz
...
%prep
%setup -q -n pytest-xdist-1.34.0
cd %{_builddir}/pytest-xdist-1.34.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595949825
...
cp %{_builddir}/pytest-xdist-1.34.0/LICENSE %{buildroot}/usr/share/package-licenses/pytest-xdist/82dbfd684f7c04da81d4faa852c6317142daa3e7
