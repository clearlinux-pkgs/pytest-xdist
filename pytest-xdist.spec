...
Source0  : https://files.pythonhosted.org/packages/17/18/bb102b7131f1c08e5d9f0a6a5904e0b4cf02160bdde1645fc386461b5423/pytest-xdist-2.1.0.tar.gz
...
%prep
%setup -q -n pytest-xdist-2.1.0
cd %{_builddir}/pytest-xdist-2.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598638834
...
cp %{_builddir}/pytest-xdist-2.1.0/LICENSE %{buildroot}/usr/share/package-licenses/pytest-xdist/82dbfd684f7c04da81d4faa852c6317142daa3e7
